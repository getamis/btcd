...
var helpDescsEnUS = map[string]string{
	...
	"getblockbaseverboseresult-strippedsize":      "The stripped size of the block",
	...
	"getblockbaseverboseresult-weight":            "The weight of the block in the block chain",
	...
	"getblockbaseverboseresult-mediantime":        "The median time in seconds since 1 Jan 1970 GMT",
	...
	"getblockbaseverboseresult-chainwork":         "The total cumulative work of the block",
	...
	"getblockheaderverboseresult-chainwork":         "The total cumulative work of the block",
...
var rpcResultTypes = map[string][]interface{}{
	...
	"getblockheader":        {(*string)(nil), (*btcjson.GetBlockBaseVerboseResult)(nil)},
